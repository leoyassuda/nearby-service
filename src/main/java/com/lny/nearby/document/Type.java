...
/**
 * List of type values available to use in place search api.
 */
public enum Type {
    ...
    DRUGSTORE, ELECTRICIAN, ELECTRONICS_STORE, EMBASSY, FIRE_STATION, FLORIST, FUNERAL_HOME, FURNITURE_STORE, GAS_STATION,
    GROCERY_OR_SUPERMARKET, GYM, HAIR_CARE, HARDWARE_STORE, HINDU_TEMPLE, HOME_GOODS_STORE, HOSPITAL, INSURANCE_AGENCY,
